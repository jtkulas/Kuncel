...
\caption{\label{fig:lastone}Response Category and Mean Rating slope across Edwards' scale values (individual scatterpoints represent items) NOTE: 1. RENAME, 2. ADD VISUAL EXAMPLES, AND 3. R.}
\end{figure}
