...
together$cond[together$cat == "ass.b1"] <- "Bottom 1%"
together$cond[together$cat == "ass.b3"] <- "Bottom 30%"
together$cond[together$cat == "ass.n"] <- "Average"
together$cond[together$cat == "ass.t3"] <- "Top 30%"
together$cond[together$cat == "ass.t1"] <- "Top 1%"

together$cond[together$cat == "qua.b1"] <- "Bottom 1%"
together$cond[together$cat == "qua.b3"] <- "Bottom 30%"
together$cond[together$cat == "qua.n"] <- "Average"
together$cond[together$cat == "qua.t3"] <- "Top 30%"
together$cond[together$cat == "qua.t1"] <- "Top 1%"

together$cond[together$cat == "lin.b1"] <- "Bottom 1%"
together$cond[together$cat == "lin.b3"] <- "Bottom 30%"
together$cond[together$cat == "lin.n"] <- "Average"
together$cond[together$cat == "lin.t3"] <- "Top 30%"
together$cond[together$cat == "lin.t1"] <- "Top 1%"
...
p <- ggplot(together, aes(x=Latency)) + geom_histogram()
p + facet_grid(~Answer)
